...
public class AdminSuccess extends JFrame {
	...
	public AdminSuccess() {
		...
		JButton btnViewLibrarytransaction = new JButton("View Library Transaction");
		btnViewLibrarytransaction.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				ViewLibraryTransaction.main(new String[]{});
			}
		});
		btnViewLibrarytransaction.setFont(new Font("Tahoma", Font.PLAIN, 15));
			...
			gl_contentPane.createParallelGroup(Alignment.TRAILING)
				...
				.addGroup(Alignment.LEADING, gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						...
						.addComponent( btnViewLibrarytransaction, GroupLayout.PREFERRED_SIZE, 181, GroupLayout.PREFERRED_SIZE)
		...
		gl_contentPane.setVerticalGroup(
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGap(18)
					.addComponent( btnViewLibrarytransaction, GroupLayout.PREFERRED_SIZE, 49, GroupLayout.PREFERRED_SIZE)
					.addGap(18)
