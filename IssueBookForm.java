...
public class IssueBookForm extends JFrame {
	...
	public IssueBookForm() {
		...
		btnIssueBook.addActionListener(new ActionListener() {
			...
			if(IssueBookDao.checkBook(bookname)){
			
			int i=IssueBookDao.save(bookname, studentid, studentname, studentcontact);
			if(i>0){
				...
				JOptionPane.showMessageDialog(IssueBookForm.this,"Sorry, book-name doesn't exist!");
